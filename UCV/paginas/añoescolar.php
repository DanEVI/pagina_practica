...
?>
		...
		<h1 style="color:black; font-family: 'Maven Pro', sans-serif; text-align: center; margin-top:20px;">Lista de Años Escolares</h1>
		<section style="font-family: 'Poppins', sans-serif; sans-serif; margin-top:20px;">
			<?php
				include "../modelo/conexion.php";
				$cn=new Conexion();
				$cn->Curso_escolarList();
			?>
		</section>
	</div>
</body>
