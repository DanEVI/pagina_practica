...
-- -----------------------------------------------
-- Crear una tabla alumno_se_matricula_asignatura
-- -----------------------------------------------
...
-- -------------------------------------------------------
-- Procedimiento almacenado para Asignatura ordenado por id
-- -------------------------------------------------------
delimiter $$
create procedure AsignaturaList()
begin
	select * from asignatura order by id;
end; $$ 

-- -------------------------------------------------------
-- Procedimiento almacenado para alumnos_se_matricula_asignatura ordenado por id_alumno 
-- -------------------------------------------------------
delimiter $$
create procedure MatriculaList()
begin
	select * from alumno_se_matricula_asignatura order by id_alumno;
end; $$ 

-- -------------------------------------------------------
-- Procedimiento almacenado para Cursoescolar ordenado por id
-- -------------------------------------------------------
delimiter $$
create procedure CursoescolarList()
begin
	select * from curso_escolar order by id;
end; $$ 

-- -------------------------------------------------------
-- Procedimiento almacenado para departamento ordenado por id
-- -------------------------------------------------------
delimiter $$
create procedure DepartamentoList()
begin
	select * from departamento order by id;
end; $$ 

-- -------------------------------------------------------
-- Procedimiento almacenado para grado ordenado por id
-- -------------------------------------------------------
delimiter $$
create procedure GradoList()
begin
	select * from grado order by id;
end; $$ 

-- -------------------------------------------------------
-- Procedimiento almacenado para persona ordenado por
-- -------------------------------------------------------
delimiter $$
create procedure PersonaList()
begin
